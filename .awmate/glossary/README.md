...
Use this folder for locale-specific translation guidance that supplements `.awmate/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/awmate/pull/12345

## Do Not Translate (Locale Additions)

- `AWMate` (preserve casing)
