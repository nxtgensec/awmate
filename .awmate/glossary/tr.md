...
- PR #15835: https://github.com/anomalyco/awmate/pull/15835

## Do Not Translate (Locale Additions)

- `AWMate` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `AWMate` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `AWMate` inside commands, URLs, package names, or code literals
