...
npm i -g awmate-ai@latest        # o bun/pnpm/yarn
scoop install awmate             # Windows
choco install awmate             # Windows
brew install anomalyco/tap/awmate # macOS y Linux (recomendado, siempre al día)
brew install awmate              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
...
AWMate también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/awmate/releases) o desde [opencode.ai/download](https://awmate.ai/download).
...
1. `$AWMATE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.awmate/bin` - Alternativa por defecto
...
AWMate incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://awmate.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar AWMate, [**ve a nuestra documentación**](https://awmate.ai/docs).

### Contribuir

Si te interesa contribuir a AWMate, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en AWMate

Si estás trabajando en un proyecto basado en AWMate y usas "awmate" como parte del nombre, por ejemplo, "awmate-dashboard" u "awmate-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de AWMate y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/awmate) | [X.com](https://x.com/awmate)
