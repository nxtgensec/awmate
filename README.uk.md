...
# Менеджери пакетів
npm i -g awmate-ai@latest        # або bun/pnpm/yarn
scoop install awmate             # Windows
choco install awmate             # Windows
brew install anomalyco/tap/awmate # macOS і Linux (рекомендовано, завжди актуально)
...
nix run nixpkgs#opencode           # або github:anomalyco/awmate для найновішої dev-гілки
```
...
AWMate також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/anomalyco/awmate/releases) або [opencode.ai/download](https://awmate.ai/download).
...
Дізнайтеся більше про [agents](https://awmate.ai/docs/agents).

### Документація

Щоб дізнатися більше про налаштування AWMate, [**перейдіть до нашої документації**](https://awmate.ai/docs).
