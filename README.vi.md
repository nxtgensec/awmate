...
npm i -g awmate-ai@latest        # hoặc bun/pnpm/yarn
scoop install awmate             # Windows
choco install awmate             # Windows
brew install anomalyco/tap/awmate # macOS và Linux (khuyên dùng, luôn cập nhật)
brew install awmate              # macOS và Linux (công thức brew chính thức, ít cập nhật hơn)
...
AWMate cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/anomalyco/awmate/releases) hoặc [opencode.ai/download](https://awmate.ai/download).
...
1. `$AWMATE_INSTALL_DIR` - Thư mục cài đặt tùy chỉnh
2. `$XDG_BIN_DIR` - Đường dẫn tuân thủ XDG Base Directory Specification
3. `$HOME/bin` - Thư mục nhị phân tiêu chuẩn của người dùng (nếu tồn tại hoặc có thể tạo)
4. `$HOME/.awmate/bin` - Mặc định dự phòng
...
AWMate bao gồm hai agent được tích hợp sẵn mà bạn có thể chuyển đổi bằng phím `Tab`.
...
Tìm hiểu thêm về [agents](https://awmate.ai/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình AWMate, [**hãy truy cập tài liệu của chúng tôi**](https://awmate.ai/docs).

### Đóng góp

Nếu bạn muốn đóng góp cho AWMate, vui lòng đọc [tài liệu hướng dẫn đóng góp](./CONTRIBUTING.md) trước khi gửi pull request.

### Xây dựng trên nền tảng AWMate

Nếu bạn đang làm việc trên một dự án liên quan đến AWMate và sử dụng "awmate" như một phần của tên dự án, ví dụ "awmate-dashboard" hoặc "awmate-mobile", vui lòng thêm một ghi chú vào README của bạn để làm rõ rằng dự án đó không được xây dựng bởi đội ngũ AWMate và không liên kết với chúng tôi dưới bất kỳ hình thức nào.

---

**Tham gia cộng đồng của chúng tôi** [Discord](https://discord.gg/awmate) | [X.com](https://x.com/awmate)
