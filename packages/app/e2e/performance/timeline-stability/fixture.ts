...
import { SessionStatusEvent } from "@awmate/schema/session-status-event"
import { SessionV1 } from "@awmate/schema/session-v1"
import type {
  AssistantMessage,
  GlobalEvent,
  Message,
...
export const directory = "C:/AWMate/TimelineStability"
