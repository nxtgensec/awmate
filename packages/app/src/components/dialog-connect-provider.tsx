import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@awmate/sdk/v2/client"
      ...
      {(i) => (
        <div class="px-1.25 w-full flex items-center gap-x-3">
          ...
          <Show when={i.id === "opencode"}>
            <div class="text-14-regular text-text-weak">{language.t("dialog.provider.awmate.tagline")}</div>
          </Show>
          ...
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              ...
              <div class="text-14-regular text-text-base">
                ...
                <Link href="https://awmate.ai/zen" tabIndex={-1}>
