...
beforeAll(async () => {
  ...
  mock.module("@awmate/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@awmate/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@awmate/ui/icon", () => ({ Icon: () => null }))
  mock.module("@awmate/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
