...
describe("buildRequestParts", () => {
  ...
  test("preserves an external attachment source path for the model", () => {
      ...
      images: [
        {
          ...
          sourcePath: "C:\\Users\\Luke\\AppData\\Roaming\\ai.awmate.desktop.beta\\opencode.global.dat",
          mime: "text/plain",
    ...
    expect(result.requestParts.find((part) => part.type === "file")?.filename).toBe(
      "C:\\Users\\Luke\\AppData\\Roaming\\ai.awmate.desktop.beta\\opencode.global.dat",
    )
  })
  ...
  test("handles macOS paths correctly", () => {
    ...
    const result = buildRequestParts({
      ...
      messageID: "msg_mac_1",
      sessionID: "ses_mac_1",
      sessionDirectory: "/Users/kelvin/Projects/awmate",
    })
    ...
    if (filePart?.type === "file") {
      ...
      expect(() => new URL(filePart.url)).not.toThrow()
      // Should be a normal Unix path
      expect(filePart.url).toBe("file:///Users/kelvin/Projects/awmate/README.md")
    }
  })
