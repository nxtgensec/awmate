...
import type { Agent } from "@awmate/sdk/v2/client"
...
describe("directoryKey", () => {
  test("normalizes slashes", () => {
    expect(String(directoryKey("C:\\Repos\\sst\\opencode"))).toBe("C:/Repos/sst/awmate")
    expect(String(directoryKey("C:/Repos/sst/awmate"))).toBe("C:/Repos/sst/awmate")
  })
