...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: AwmateClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: AwmateClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: AwmateClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => AwmateClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, AwmateClient>()
