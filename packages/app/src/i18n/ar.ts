export const dict = {
  ...
  "dialog.provider.awmate.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.awmate.tagline": "نماذج موثوقة ومحسنة",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من AWMate",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك AWMate Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في AWMate.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في awmate.json",
  ...
  "dialog.server.description": "تبديل خادم AWMate الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من AWMate في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث AWMate في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث AWMate في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "AWMate جاهز.",
  "wsl.onboarding.installAwmateIn": "ثبّت AWMate في {{distro}}.",
  "wsl.onboarding.installAwmate": "تثبيت AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن AWMate من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على AWMate التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح AWMate.",
  ...
  "toast.update.description": "نسخة جديدة من AWMate ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق AWMate",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (awmate.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن AWMate لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن AWMate نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم AWMate داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ AWMate",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور AWMate على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان AWMate يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة AWMate.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل AWMate",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من AWMate.",
