export const dict = {
  ...
  "dialog.provider.awmate.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.awmate.tagline": "Modelos otimizados e confiáveis",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo AWMate",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no AWMate.",
  ...
  "dialog.plugins.empty": "Plugins configurados em awmate.json",
  ...
  "dialog.server.description": "Trocar para qual servidor AWMate este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o AWMate em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o AWMate em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o AWMate em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o AWMate",
  "wsl.onboarding.opencodeReadyIn": "O AWMate está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O AWMate está pronto.",
  "wsl.onboarding.installAwmateIn": "Instale o AWMate em {{distro}}.",
  "wsl.onboarding.installAwmate": "Instalar o AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o AWMate possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O AWMate não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o AWMate novamente.",
  ...
  "toast.update.description": "Uma nova versão do AWMate ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do AWMate",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (awmate.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: AWMate ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor AWMate dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do AWMate",
  ...
  "settings.general.row.appearance.description": "Personalize como o AWMate aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o AWMate segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o AWMate é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o AWMate iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do AWMate.",
