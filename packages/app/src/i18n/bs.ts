export const dict = {
  ...
  "dialog.provider.awmate.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.awmate.tagline": "Pouzdani optimizovani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje AWMate",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u AWMate-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u AWMate-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u AWMate-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u awmate.json",
  ...
  "dialog.server.description": "Promijeni na koji se AWMate server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera AWMate u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje AWMate u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj AWMate u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "AWMate je spreman.",
  "wsl.onboarding.installAwmateIn": "Instaliraj AWMate u distribuciji {{distro}}.",
  "wsl.onboarding.installAwmate": "Instaliraj AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi AWMate mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "AWMate nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori AWMate.",
  ...
  "toast.update.description": "Nova verzija AWMate-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku AWMate timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (awmate.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: AWMate još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AWMate uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni AWMate server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u AWMate-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako AWMate izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li AWMate prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu AWMate-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se AWMate pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju AWMate-a.",
