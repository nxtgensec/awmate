export const dict = {
  ...
  "dialog.provider.awmate.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.awmate.tagline": "Pålidelige optimerede modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af AWMate",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i AWMate.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i awmate.json",
  ...
  "dialog.server.description": "Skift hvilken AWMate-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker AWMate i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer AWMate i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater AWMate i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før AWMate kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "AWMate kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter AWMate igen.",
  ...
  "toast.update.description": "En ny version af AWMate ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til AWMate-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (awmate.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, AWMate understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "AWMate inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør AWMate-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for AWMate",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan AWMate ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om AWMate følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan AWMate er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når AWMate starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af AWMate.",
