...
export const dict = {
  ...
  "dialog.provider.awmate.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.awmate.tagline": "Zuverlässige, optimierte Modelle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von AWMate",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in AWMate zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.link": "awmate.ai/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in AWMate zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in AWMate zu nutzen.",
  ...
  "dialog.plugins.empty": "In awmate.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den AWMate-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.awmate": "AWMate",
  ...
  "wsl.onboarding.checkingOpencode": "AWMate wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "AWMate in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "AWMate wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "AWMate in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie AWMate in {{distro}}.",
  "wsl.onboarding.updateOpencode": "AWMate aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "AWMate ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "AWMate ist bereit.",
  "wsl.onboarding.installAwmateIn": "Installieren Sie AWMate in {{distro}}.",
  "wsl.onboarding.installAwmate": "AWMate installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor AWMate einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "AWMate konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann AWMate erneut.",
  ...
  "toast.update.description": "Eine neue Version von AWMate ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem AWMate-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (awmate.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: AWMate unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "AWMate enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "AWMate-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für AWMate ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie AWMate auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob AWMate dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von AWMate anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von AWMate automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von AWMate.",
