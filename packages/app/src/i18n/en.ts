export const dict = {
  ...
  "dialog.provider.awmate.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.awmate.tagline": "Reliable optimized models",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AWMate",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AWMate.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "AWMate Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AWMate.",
  ...
  "dialog.plugins.empty": "Plugins configured in awmate.json",
  ...
  "dialog.server.description": "Switch which AWMate server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Checking AWMate in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Updating AWMate in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update AWMate in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AWMate is ready.",
  "wsl.onboarding.installAwmateIn": "Install AWMate in {{distro}}.",
  "wsl.onboarding.installAwmate": "Install AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before AWMate can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "AWMate could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AWMate.",
  ...
  "toast.update.description": "A new version of AWMate ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AWMate team",
  ...
  "error.chain.checkConfig": "Check your config (awmate.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AWMate does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AWMate includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the AWMate server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AWMate",
  ...
  "settings.general.row.appearance.description": "Customise how AWMate looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AWMate follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AWMate is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AWMate launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AWMate.",
