export const dict = {
  ...
  "dialog.provider.awmate.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.awmate.tagline": "Modelos optimizados y fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por AWMate",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en AWMate.",
  ...
  "dialog.plugins.empty": "Plugins configurados en awmate.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de AWMate se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando AWMate en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando AWMate en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza AWMate en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "AWMate está listo.",
  "wsl.onboarding.installAwmateIn": "Instala AWMate en {{distro}}.",
  "wsl.onboarding.installAwmate": "Instalar AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que AWMate pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "AWMate no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir AWMate.",
  ...
  "toast.update.description": "Una nueva versión de AWMate ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de AWMate",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (awmate.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, AWMate no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "AWMate incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor AWMate dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para AWMate",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve AWMate en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si AWMate sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de AWMate.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia AWMate",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de AWMate.",
