export const dict = {
  ...
  "dialog.provider.awmate.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.awmate.tagline": "Modèles optimisés et fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par AWMate",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans AWMate.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans awmate.json",
  ...
  "dialog.server.description": "Changez le serveur AWMate auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'AWMate dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'AWMate dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour AWMate dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "AWMate est prêt.",
  "wsl.onboarding.installAwmateIn": "Installez AWMate dans {{distro}}.",
  "wsl.onboarding.installAwmate": "Installer AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'AWMate puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "AWMate n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez AWMate.",
  ...
  "toast.update.description":
    "Une nouvelle version d'AWMate ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe AWMate",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (awmate.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'AWMate ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "AWMate inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur AWMate dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour AWMate",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'AWMate sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si AWMate suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'AWMate.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'AWMate",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'AWMate.",
