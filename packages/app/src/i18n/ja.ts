export const dict = {
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.awmate.tagline": "信頼性の高い最適化モデル",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMateが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、AWMateで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAWMateで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、AWMateで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "awmate.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するAWMateサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "AWMateを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のAWMateを確認中...",
  "wsl.onboarding.updatingOpencode": "AWMateを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のAWMateを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のAWMateを更新してください。",
  "wsl.onboarding.updateOpencode": "AWMateを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のAWMateの準備ができました。",
  "wsl.onboarding.opencodeReady": "AWMateの準備ができました。",
  "wsl.onboarding.installAwmateIn": "{{distro}}にAWMateをインストールしてください。",
  "wsl.onboarding.installAwmate": "AWMateをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMateがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AWMateでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、AWMateをもう一度開いてください。",
  ...
  "toast.update.description": "AWMateの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAWMateチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (awmate.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: AWMateはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "AWMateには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAWMateサーバーを実行します。",
  ...
  "settings.general.row.language.description": "AWMateの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのAWMateの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "AWMateがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "AWMateのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "AWMate の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "AWMate は最新バージョンです。",
