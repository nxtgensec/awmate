export const dict = {
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.awmate.tagline": "신뢰할 수 있는 최적화 모델",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 AWMate에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 AWMate에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 AWMate에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "awmate.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 AWMate 서버를 전환합니다.",
  ...
  "toast.update.description": "AWMate의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 AWMate 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(awmate.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: AWMate는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "AWMate에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 AWMate 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "AWMate 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 AWMate가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "AWMate가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "AWMate 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "AWMate를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 AWMate를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "AWMate 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 AWMate 확인 중...",
  "wsl.onboarding.updatingOpencode": "AWMate 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 AWMate 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 AWMate를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "AWMate 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 AWMate를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "AWMate가 준비되었습니다.",
  "wsl.onboarding.installAwmateIn": "{{distro}}에 AWMate를 설치하세요.",
  "wsl.onboarding.installAwmate": "AWMate 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AWMate에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "AWMate에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 AWMate를 다시 여세요.",
