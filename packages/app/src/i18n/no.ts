...
export const dict = {
  ...
  "dialog.provider.awmate.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.awmate.tagline": "Pålitelige, optimaliserte modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av AWMate",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i AWMate.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i awmate.json",
  ...
  "dialog.server.description": "Bytt hvilken AWMate-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av AWMate ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til AWMate-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (awmate.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at AWMate ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "AWMate inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør AWMate-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for AWMate",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan AWMate ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om AWMate skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan AWMate er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når AWMate starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av AWMate.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker AWMate i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer AWMate i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater AWMate i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "AWMate er klar.",
  "wsl.onboarding.installAwmateIn": "Installer AWMate i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før AWMate kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "AWMate kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter AWMate på nytt.",
