export const dict = {
  ...
  "dialog.provider.awmate.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.awmate.tagline": "Niezawodne, zoptymalizowane modele",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AWMate",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AWMate.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w awmate.json",
  ...
  "dialog.server.description": "Przełącz serwer AWMate, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie AWMate w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie AWMate w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj AWMate w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "AWMate jest gotowy.",
  "wsl.onboarding.installAwmateIn": "Zainstaluj AWMate w dystrybucji {{distro}}.",
  "wsl.onboarding.installAwmate": "Zainstaluj AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim AWMate będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "AWMate nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz AWMate.",
  ...
  "toast.update.description": "Nowa wersja AWMate ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AWMate",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (awmate.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: AWMate nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "AWMate zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer AWMate wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AWMate",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd AWMate na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AWMate ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AWMate.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AWMate",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AWMate.",
