export const dict = {
  ...
  "dialog.provider.awmate.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.awmate.tagline": "Надежные оптимизированные модели",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от AWMate",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в AWMate.",
  ...
  "dialog.plugins.empty": "Плагины настроены в awmate.json",
  ...
  "dialog.server.description": "Переключите сервер AWMate к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка AWMate в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление AWMate в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите AWMate в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "AWMate готов к работе.",
  "wsl.onboarding.installAwmateIn": "Установите AWMate в {{distro}}.",
  "wsl.onboarding.installAwmate": "Установить AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в AWMate требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "AWMate не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте AWMate.",
  ...
  "toast.update.description": "Новая версия AWMate ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде AWMate",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (awmate.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что AWMate пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "AWMate включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер AWMate внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения AWMate",
  ...
  "settings.general.row.appearance.description": "Настройте как AWMate выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли AWMate системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление AWMate.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске AWMate",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию AWMate.",
