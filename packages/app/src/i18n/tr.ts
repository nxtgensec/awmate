...
export const dict = {
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.awmate.tagline": "Güvenilir optimize edilmiş modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AWMate'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak AWMate'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AWMate'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler awmate.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AWMate sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "AWMate kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde AWMate kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "AWMate güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde AWMate güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki AWMate'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "AWMate'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde AWMate hazır.",
  "wsl.onboarding.opencodeReady": "AWMate hazır.",
  "wsl.onboarding.installAwmateIn": "AWMate'u {{distro}} içine kurun.",
  "wsl.onboarding.installAwmate": "AWMate'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AWMate'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "AWMate bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından AWMate'u tekrar açın.",
  ...
  "toast.update.description": "AWMate'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AWMate ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (awmate.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: AWMate henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AWMate ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "AWMate Masaüstü",
  ...
  "settings.desktop.wsl.description": "AWMate sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "AWMate'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "AWMate'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AWMate'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AWMate'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AWMate başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AWMate'un en son sürümünü kullanıyorsunuz.",
