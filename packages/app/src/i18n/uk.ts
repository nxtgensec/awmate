export const dict = {
  ...
  "dialog.provider.awmate.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.awmate.tagline": "Надійні оптимізовані моделі",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від AWMate",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у AWMate.",
  ...
  "provider.connect.opencodeZen.line1":
    "AWMate Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у AWMate.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в awmate.json",
  ...
  "dialog.server.description": "Перемкніть сервер AWMate, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка AWMate у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення AWMate у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть AWMate у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити AWMate",
  "wsl.onboarding.opencodeReadyIn": "AWMate готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "AWMate готовий до роботи.",
  "wsl.onboarding.installAwmateIn": "Встановіть AWMate у {{distro}}.",
  "wsl.onboarding.installAwmate": "Встановити AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AWMate не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в AWMate потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "AWMate не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте AWMate.",
  ...
  "toast.update.description": "Нова версія AWMate ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді AWMate",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (awmate.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, AWMate ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер AWMate всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу AWMate",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд AWMate на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи AWMate використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему AWMate.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску AWMate",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію AWMate.",
