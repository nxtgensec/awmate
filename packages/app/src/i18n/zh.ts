...
export const dict = {
  ...
  "dialog.provider.awmate.note": "使用 AWMate Zen 或 API 密钥连接",
  "dialog.provider.awmate.tagline": "可靠的优化模型",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 AWMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "AWMate Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 AWMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 AWMate 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 awmate.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 AWMate 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 AWMate...",
  "wsl.onboarding.updatingOpencode": "正在更新 AWMate...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 AWMate...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 AWMate。",
  "wsl.onboarding.updateOpencode": "更新 AWMate",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 AWMate 已就绪。",
  "wsl.onboarding.opencodeReady": "AWMate 已就绪。",
  "wsl.onboarding.installAwmateIn": "在 {{distro}} 中安装 AWMate。",
  "wsl.onboarding.installAwmate": "安装 AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 AWMate",
  ...
  "wsl.onboarding.wslNotInstalled.description": "AWMate 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "AWMate 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 AWMate。",
  ...
  "toast.update.description": "AWMate 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 AWMate 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (awmate.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: AWMate 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "AWMate 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 AWMate 服务器。",
  ...
  "settings.general.row.language.description": "更改 AWMate 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 AWMate 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 AWMate 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 AWMate 的主题。",
  ...
  "settings.updates.row.startup.description": "在 AWMate 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 AWMate。",
