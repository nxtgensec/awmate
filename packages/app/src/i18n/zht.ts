...
export const dict = {
  ...
  "dialog.provider.awmate.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.awmate.tagline": "可靠的優化模型",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 AWMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "AWMate Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 AWMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 AWMate 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 awmate.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 AWMate 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 AWMate...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 AWMate...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 AWMate 已就緒。",
  "wsl.onboarding.opencodeReady": "AWMate 已就緒。",
  "wsl.onboarding.installAwmateIn": "在 {{distro}} 中安裝 AWMate。",
  "wsl.onboarding.installAwmate": "安裝 AWMate",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 AWMate",
  ...
  "wsl.onboarding.wslUnavailable.description": "AWMate 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 AWMate。",
  ...
  "toast.update.description": "AWMate 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 AWMate 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (awmate.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: AWMate 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "AWMate 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 AWMate 伺服器。",
  ...
  "settings.general.row.language.description": "變更 AWMate 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 AWMate 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 AWMate 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 AWMate 的主題。",
  ...
  "settings.updates.row.startup.description": "在 AWMate 啟動時自動檢查更新",
