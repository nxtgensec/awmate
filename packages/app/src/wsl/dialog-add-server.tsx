...
import { showToast } from "@awmate/ui/toast"
import { ButtonV2 } from "@awmate/ui/v2/button-v2"
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogTitle } from "@awmate/ui/v2/dialog-v2"
import { DividerV2 } from "@awmate/ui/v2/divider-v2"
import { LoaderV2 } from "@awmate/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@awmate/ui/v2/radio-v2"
import { TextInputV2 } from "@awmate/ui/v2/text-input-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-awmate") {
      await run(() => api.installAwmate(distro))
      return
    }
