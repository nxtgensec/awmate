...
declare const AWMATE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof AWMATE_CLI_NAME === "string" ? AWMATE_CLI_NAME : "awmate", {
  description: "AWMate command line interface",
  commands: [
    Spec.make("api", {
