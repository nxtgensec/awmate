...
import { compile, emitEffectImported, emitPromise, write } from "@awmate/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@awmate/protocol/groups/event"',
            },
          },
        }),
