...
import desktopAppIcon from "../../asset/lander/awmate-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g awmate-ai")}>
                <code>
                  npm i -g <strong>awmate-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g awmate-ai")}>
                <code>
                  bun add -g <strong>awmate-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/awmate")}>
                <code>
                  brew install <strong>anomalyco/tap/awmate</strong>
                </code>
                <CopyStatus />
              </button>
