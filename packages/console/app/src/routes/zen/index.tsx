...
import compareVideo from "../../asset/lander/awmate-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/awmate-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="awmate:auth" content={loggedin() ? "true" : "false"} />
