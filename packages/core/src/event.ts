...
import type { Data, Definition, Payload } from "@awmate/schema/event"
...
import { Durable } from "@awmate/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@awmate/schema/event").ID
export type { Data, Definition, Payload } from "@awmate/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/Event") {}
