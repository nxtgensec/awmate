...
import { Entry, FileSystem, FindInput, Match } from "@awmate/schema/filesystem"
export { Entry, Match, Submatch } from "@awmate/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/v2/FileSystem") {}
