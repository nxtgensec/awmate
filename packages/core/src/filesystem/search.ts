...
export class Service extends Context.Service<Service, Interface>()("@awmate/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.AWMATE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
