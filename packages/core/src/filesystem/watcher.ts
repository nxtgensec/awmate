...
import { FileSystemWatcher } from "@awmate/schema/filesystem-watcher"
...
declare const AWMATE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof AWMATE_LIBC === "undefined" ? undefined : AWMATE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@awmate/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.AWMATE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.AWMATE_EXPERIMENTAL_FILEWATCHER)) {
