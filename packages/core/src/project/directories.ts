...
import type { EffectDrizzleSqlite } from "@awmate/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/ProjectDirectories") {}
