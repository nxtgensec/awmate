...
import { ListAnchor } from "@awmate/schema/session"
...
import { SessionDurable } from "@awmate/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/v2/Session") {}
