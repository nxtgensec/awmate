...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@awmate/llm"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/v2/ToolRegistry") {}
