...
const releaseId = process.env.AWMATE_RELEASE
if (!releaseId) throw new Error("AWMATE_RELEASE is required")

const version = process.env.AWMATE_VERSION
if (!version) throw new Error("AWMATE_VERSION is required")
...
const macxTarGz = "awmate-desktop-mac-x64.app.tar.gz"
const macaTarGz = "awmate-desktop-mac-arm64.app.tar.gz"
