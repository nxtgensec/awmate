export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de AWMate",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de AWMate. ¿Quieres instalarla y reiniciar?",
