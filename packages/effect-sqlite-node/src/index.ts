...
export const TypeId: TypeId = "~@awmate/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@awmate/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@awmate/effect-sqlite-node/NodeSqliteClient")
