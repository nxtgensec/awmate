...
Practical reference for the current tool-migration state in `packages/awmate`.
...
Tool tests should use the existing Effect helpers in `packages/awmate/test/lib/effect.ts`:
