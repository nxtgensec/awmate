...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@awmate/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@awmate/ACPDirectory") {}
