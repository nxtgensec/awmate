...
import { AbsolutePath, type DeepMutable } from "@awmate/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".awmate", "plans", "*.md")]: "allow",
