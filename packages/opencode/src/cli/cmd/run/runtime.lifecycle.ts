...
import { openEditor } from "@awmate/tui/editor"
import { registerAwmateKeymap } from "@awmate/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerAwmateKeymap(keymap, renderer, input.tuiConfig)
