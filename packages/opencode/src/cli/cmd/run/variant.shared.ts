...
//
// The saved variant persists across sessions in ~/.local/state/awmate/model.json
...
class Service extends Context.Service<Service, VariantService>()("@awmate/RunVariant") {}
