 ...
 *   "@awmate/ServerAuthConfig",
 *   {
 *     password: Config.string("AWMATE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AWMATE_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
