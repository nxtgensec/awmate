...
export class Service extends Context.Service<Service, Interface>()("@awmate/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __AWMATE_PHOTON_WASM_PATH?: string }).__AWMATE_PHOTON_WASM_PATH =
