import type { Hooks, PluginInput } from "@awmate/plugin"
import type { Model } from "@awmate/sdk/v2"
import { InstallationVersion } from "@awmate/core/installation/version"
import { OauthCallbackPage } from "@awmate/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. AWMate will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
