...
import { ProjectDirectoryTable, ProjectTable } from "@awmate/core/project/sql"
import { ProjectDirectories } from "@awmate/core/project/directories"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.AWMATE_FAKE_VCS)
