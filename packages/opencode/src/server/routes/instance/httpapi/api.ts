...
import { makeApi } from "@awmate/protocol/api"
import { LocationMiddleware } from "@awmate/server/location"
import { SessionLocationMiddleware } from "@awmate/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("awmate-root")
...
export const InstanceHttpApi = HttpApi.make("awmate-instance")
...
export const AWMateHttpApi = HttpApi.make("awmate")
