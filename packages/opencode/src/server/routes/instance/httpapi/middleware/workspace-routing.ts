...
>()("@awmate/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@awmate/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.AWMATE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.AWMATE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return (
    ...
    request.headers["x-awmate-directory"] ||
    decodeDirectoryHeader(request.headers["x-opencode-directory"]) ||
    process.cwd()
  )
}
