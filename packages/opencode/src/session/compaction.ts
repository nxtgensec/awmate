...
import { buildPrompt } from "@awmate/core/session/compaction"
import { SessionCompactionEvent } from "@awmate/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/SessionCompaction") {}
