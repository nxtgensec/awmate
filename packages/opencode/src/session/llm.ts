...
import { llmClient } from "@awmate/core/effect/app-node-platform"
...
import { LLMClient } from "@awmate/llm/route"
import type { LLMClientService } from "@awmate/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @awmate/llm. It
