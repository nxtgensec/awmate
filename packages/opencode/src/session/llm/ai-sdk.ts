import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@awmate/llm"
...
// Move this extraction into @awmate/llm when Copilot is handled by the native runtime.
