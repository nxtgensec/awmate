import type { JsonSchema, LLMRequest, ProviderMetadata } from "@awmate/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@awmate/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @awmate/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
