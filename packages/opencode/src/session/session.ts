...
import type { ProviderMetadata, Usage } from "@awmate/llm"
...
import { locationServiceMapLayer } from "@awmate/core/location-services"
...
import { PartTable, SessionTable } from "@awmate/core/session/sql"
...
import { NonNegativeInt, optional } from "@awmate/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".awmate", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@awmate/Session") {}
