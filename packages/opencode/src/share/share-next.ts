...
import type * as SDK from "@awmate/sdk/v2"
...
import { SessionShareTable } from "@awmate/core/share/sql"
import { ProviderV2 } from "@awmate/core/provider"
import { ModelV2 } from "@awmate/core/model"
import { EventV2 } from "@awmate/core/event"

const disabled = process.env["AWMATE_DISABLE_SHARE"] === "true" || process.env["AWMATE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/ShareNext") {}
