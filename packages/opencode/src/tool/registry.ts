...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@awmate/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@awmate/ToolRegistry") {}
