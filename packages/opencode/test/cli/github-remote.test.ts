...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/awmate.git")).toEqual({ owner: "sst", repo: "awmate" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/awmate")).toEqual({ owner: "sst", repo: "awmate" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/awmate.git")).toEqual({ owner: "sst", repo: "awmate" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/awmate")).toEqual({ owner: "sst", repo: "awmate" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/awmate.git")).toEqual({ owner: "sst", repo: "awmate" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/awmate")).toEqual({ owner: "sst", repo: "awmate" })
})
