...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AWMATE_CALLER", () => {
    process.env["AWMATE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AWMATE_CALLER", () => {
    process.env["AWMATE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AWMATE_CALLER", () => {
    process.env["AWMATE_CALLER"] = "unknown"
