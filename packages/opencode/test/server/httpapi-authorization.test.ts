...
const noAuthLayer = ServerAuth.Config.configLayer({ password: Option.none(), username: "awmate" })
const secretLayer = ServerAuth.Config.configLayer({ password: Option.some("secret"), username: "awmate" })
