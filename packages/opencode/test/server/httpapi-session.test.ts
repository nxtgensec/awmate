...
import { SessionInputTable, SessionMessageTable, SessionTable } from "@awmate/core/session/sql"
...
const originalWorkspaces = Flag.AWMATE_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  Flag.AWMATE_EXPERIMENTAL_WORKSPACES = originalWorkspaces
...
describe("session HttpApi", () => {
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        const test = yield* TestInstance
        Flag.AWMATE_EXPERIMENTAL_WORKSPACES = true
