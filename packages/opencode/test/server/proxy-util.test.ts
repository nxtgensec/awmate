...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips directory and workspace routing headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-opencode-directory": "/home/user/project",
          "x-opencode-workspace": "ws_123",
          "x-awmate-directory": "/home/user/project",
          "x-awmate-workspace": "ws_123",
      ...
      expect(result.get("x-awmate-directory")).toBeNull()
      expect(result.get("x-awmate-workspace")).toBeNull()
