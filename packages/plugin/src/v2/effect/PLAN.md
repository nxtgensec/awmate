...
- Effect plugins import `@awmate/plugin/v2/effect`, not `@awmate/core`.
- Public domain values use generated `@awmate/sdk` types.
...
- Define `PluginHost` domain capabilities in `@awmate/plugin/v2/effect`.
