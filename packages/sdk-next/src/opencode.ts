import { AWMate } from "@awmate/client/effect"
...
import { createEmbeddedRoutes } from "@awmate/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("AWMate.create")(function* () {
  ...
  const client = yield* AWMate.make({ baseUrl: "http://awmate.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@awmate/sdk-next/AWMate") {}
