...
import { createOpencode, type ToolPart } from "@awmate/sdk"
...
console.log("🚀 Starting awmate server...")
...
app.message(async ({ message, say }) => {
  ...
  if (!session) {
    console.log("🆕 Creating new awmate session...")
    ...
    console.log("✅ Created awmate session:", createResult.data.id)
