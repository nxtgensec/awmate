...
const en = {
  "app.title": "AI Model Usage Rankings | AWMate Data",
  "app.description":
    "Explore AWMate Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "AWMate Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star AWMate on GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Try AWMate",
  ...
  "home.topModelsDescription": "Usage of models across AWMate Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique AWMate Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | AWMate Data",
  "lab.description":
    "Compare {{lab}} models used in AWMate Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent AWMate usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in AWMate",
  ...
  "lab.shareOfUsage": "{{share}} of recent AWMate usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | AWMate Data",
  "model.description":
    "View {{model}} AWMate Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. AWMate Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's AWMate Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's AWMate Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No AWMate Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no AWMate Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "AWMate Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No AWMate Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent AWMate Go token volume.",
