export const dict = {
  "app.title": "Ranking de uso de modelos de IA | AWMate Data",
  "app.description":
    "Explore o uso do AWMate Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do AWMate Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao AWMate no GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Experimente o AWMate",
  ...
  "footer.homeAria": "Início do AWMate",
  ...
  "modal.title": "Newsletter do AWMate",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no AWMate Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do AWMate Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | AWMate Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no AWMate Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do AWMate.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no AWMate",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do AWMate",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do AWMate nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | AWMate Data",
  "model.description":
    "Veja dados de uso de {{model}} no AWMate Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no AWMate Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do AWMate Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do AWMate Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do AWMate Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do AWMate Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do AWMate Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do AWMate Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do AWMate Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do AWMate Go.",
  ...
  "model.geoDescription": "Tokens do modelo AWMate Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do AWMate Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do AWMate Go.",
