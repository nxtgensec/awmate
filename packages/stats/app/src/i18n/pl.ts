export const dict = {
  "app.title": "Rankingi użycia modeli AI | AWMate Data",
  "app.description":
    "Przeglądaj użycie AWMate Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny AWMate Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę AWMate na GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Wypróbuj AWMate",
  ...
  "footer.homeAria": "Strona główna AWMate",
  ...
  "home.topModelsDescription": "Użycie modeli w AWMate Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy AWMate Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | AWMate Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w AWMate Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia AWMate.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w AWMate",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia AWMate",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów AWMate z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | AWMate Data",
  "model.description":
    "Zobacz dane użycia {{model}} w AWMate Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie AWMate Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu AWMate Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu AWMate Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia AWMate Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny AWMate Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia AWMate Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów AWMate Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy AWMate Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji AWMate Go.",
  ...
  "model.geoDescription": "Tokeny modelu AWMate Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne AWMate Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów AWMate Go.",
