export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | AWMate Data",
  "app.description":
    "AWMate Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde AWMate Data logosu",
  ...
  "header.githubAria": "GitHub'da AWMate'a yıldız ver",
  "header.github": "GitHub",
  "header.tryOpenCode": "AWMate'u dene",
  ...
  "footer.homeAria": "AWMate ana sayfası",
  ...
  "home.topModelsDescription": "AWMate Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz AWMate Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | AWMate Data",
  "lab.description":
    "AWMate Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son AWMate kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "AWMate'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son AWMate kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük AWMate token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | AWMate Data",
  "model.description":
    "{{model}} için AWMate Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda AWMate Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki AWMate Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki AWMate Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde AWMate Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son AWMate Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz AWMate Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük AWMate Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz AWMate Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama AWMate Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan AWMate Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen AWMate Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son AWMate Go token hacmine göre yakındaki modeller.",
