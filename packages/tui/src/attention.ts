...
import defaultSoundPath from "@awmate/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@awmate/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@awmate/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@awmate/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@awmate/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@awmate/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "awmate"
const DEFAULT_PACK_ID = "awmate.default"
