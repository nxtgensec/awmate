...
import { registerAwmateSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@awmate/sdk/v2"
...
import { AWMATE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useAwmateKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.AWMATE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
