import type { TuiPlugin, TuiPluginApi } from "@awmate/plugin/tui"
...
function View(props: { api: TuiPluginApi; sessionID: string }) {
  ...
  return (
    <box gap={1}>
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>AWMate includes free models so you can start immediately.</text>
      ...
      <text fg={theme().textMuted}>
        <span style={{ fg: theme().success }}>•</span> <b>AW</b>
