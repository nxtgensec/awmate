...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/awmate/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/awmate (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/awmate/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/awmate/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const AWMATE_DB|AWMATE_DB|AWMATE_DEV|Global\\.Path\\.data|data =" in packages/awmate/src (115 matches)',
  },
] as const
