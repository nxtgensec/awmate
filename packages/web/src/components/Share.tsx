...
import { IconAwmate } from "./icons/custom"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.awmate_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.awmate_name}>
                    <IconAwmate width={16} height={16} />
                  </div>
