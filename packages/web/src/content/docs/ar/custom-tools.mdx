...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في AWMate.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في AWMate مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.awmate/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/awmate/tools/`.
