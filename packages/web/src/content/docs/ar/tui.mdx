---
title: TUI
description: استخدام واجهة المستخدم TUI في AWMate.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر AWMate واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل AWMate إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة AWMate في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى AWMate. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من AWMate. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `awmate.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار AWMate بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `AWMate.default`.
