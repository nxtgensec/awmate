...
Kreiraj `.awmate/commands/test.md`:
...
Možete dodati prilagođene komande kroz AWMate konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom AWMate [config](/docs/config):
...
- Globalno: `~/.config/awmate/commands/`
- Po projektu: `.awmate/commands/`
...
AWMate uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
