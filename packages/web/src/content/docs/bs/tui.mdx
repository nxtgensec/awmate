---
title: TUI
description: Korištenje korisničkog interfejsa AWMate terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AWMate pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje AWMate pokreće TUI za trenutni direktorij.
...
Kada koristite AWMate TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u AWMate. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz AWMate. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `awmate.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo AWMate čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `AWMate.default`.
