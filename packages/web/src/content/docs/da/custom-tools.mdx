...
description: Opret værktøjer, som LLM kan kalde AWMate ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med AWMates [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.awmate/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/awmate/tools/`.
