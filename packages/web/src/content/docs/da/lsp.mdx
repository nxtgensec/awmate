---
title: LSP-servere
description: AWMate integreres med dine LSP-servere.
---

AWMate kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

AWMate leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `AWMate_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og AWMate åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din AWMate-konfiguration.
