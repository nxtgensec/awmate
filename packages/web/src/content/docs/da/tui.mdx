---
title: TUI
description: Brug af AWMate-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AWMate giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre AWMate starter TUI for den nuværende mappe.
...
Når du bruger AWMate TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til AWMate. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut AWMate. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `awmate.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe AWMate venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `AWMate.default`.
