...
Erstellen Sie `.awmate/commands/test.md`:

```md title=".awmate/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die AWMate-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem AWMate [config](/docs/config):

```json title="awmate.jsonc" {4-12}
{
...
- Global: `~/.config/awmate/commands/`
- Pro Projekt: `.awmate/commands/`

```markdown title="~/.config/awmate/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".awmate/commands/component.md"
---
...
```md title=".awmate/commands/create-file.md"
---
...
```md title=".awmate/commands/analyze-coverage.md"
---
...
```md title=".awmate/commands/review-changes.md"
---
...
```md title=".awmate/commands/review-component.md"
---
...
AWMate enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
