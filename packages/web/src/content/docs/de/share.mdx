---
title: Teilen
description: Teile AWMate-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu AWMate-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht AWMate Folgendes:
...
AWMate hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt AWMate den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`awmate.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du AWMate in deiner Organisation einsetzt.
