...
Puede agregar comandos personalizados a través de la configuración AWMate o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su AWMate [config](/docs/config):
...
AWMate incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
