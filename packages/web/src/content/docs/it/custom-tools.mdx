...
description: Crea strumenti che l'LLM puo chiamare in AWMate.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di AWMate come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.awmate/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/awmate/tools/`.
