---
title: LSP-servere
description: AWMate integreres med LSP-serverne dine.
---

AWMate kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

AWMate kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `AWMate_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og AWMate åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i AWMate-konfigurasjonen.
