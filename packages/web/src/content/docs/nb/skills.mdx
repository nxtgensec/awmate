...
Agentferdigheter lar AWMate oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går AWMate opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
AWMate viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `awmate.json`:
