---
title: TUI
description: Bruke AWMate-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AWMate gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre AWMate starter TUI for gjeldende katalog.
...
Når du bruker AWMate TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til AWMate. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt AWMate. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `awmate.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge AWMate venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `AWMate.default`.
