---
title: Zen
description: Utvalgt liste over modeller levert av AWMate.
---
...
AWMate Zen er en liste over testede og verifiserte modeller levert av AWMate-teamet.

Zen fungerer som enhver annen leverandør i AWMate. Du logger inn på AWMate Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med AWMate.
:::
...
AWMate Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

AWMate Zen fungerer som enhver annen leverandør i AWMate.

1. Du logger inn på **<a href={console}>AWMate Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger AWMate Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i AWMate-konfigurasjonen din
bruker formatet `awmate/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `awmate/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på AWMate i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på AWMate i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på AWMate i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på AWMate i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på AWMate i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med AWMate også.
