...
Utwórz `.awmate/commands/test.md`:
...
Możesz zdefiniować polecenia w `awmate.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji AWMate:
...
- Globalnie: `~/.config/awmate/commands/`
- Na projekt: `.awmate/commands/`
...
AWMate zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
