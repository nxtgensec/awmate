---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące AWMate.
---

Funkcja udostępniania AWMate umożliwia tworzenie publicznych linków do konwersacji AWMate, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, AWMate:
...
AWMate obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie AWMate korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `awmate.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu AWMate w Twojej organizacji.
