---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala AWMate.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AWMate zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie AWMate uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI AWMate, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do AWMate. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij AWMate. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `awmate.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo AWMate czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `AWMate.default`.
