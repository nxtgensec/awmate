---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez AWMate.
---
...
AWMate Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół AWMate.

Zen działa jak każdy inny dostawca w AWMate. Logujesz się do AWMate Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z AWMate.
:::
...
AWMate Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

AWMate Zen działa jak każdy inny dostawca w AWMate.

1. Logujesz się do **<a href={console}>AWMate Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz AWMate Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji AWMate używa formatu
`awmate/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`awmate/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w AWMate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w AWMate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w AWMate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w AWMate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w AWMate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w AWMate także dowolnego innego dostawcy.
