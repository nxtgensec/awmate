...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ AWMate:
...
- ระดับผู้ใช้ (Global): `~/.config/awmate/commands/`
- ระดับโปรเจ็กต์: `.awmate/commands/`
...
AWMate มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
