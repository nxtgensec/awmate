---
title: Özel Araçlar
description: LLM'un AWMate'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. AWMate'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.awmate/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/awmate/tools/` içine yerleştirerek.
