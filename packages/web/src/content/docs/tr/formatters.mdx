...
description: AWMate dile özgü biçimlendiriciler kullanır.
---

AWMate, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

AWMate, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, AWMate bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

AWMate bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri AWMate yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
