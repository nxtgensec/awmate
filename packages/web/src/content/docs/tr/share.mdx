---
title: Paylasim
description: AWMate konusmalarini genel baglantilarla paylasin.
---

AWMate'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda AWMate:
...
AWMate, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak AWMate manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `awmate.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda AWMate kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
