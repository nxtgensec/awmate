---
title: Zen
description: AWMate tarafından sağlanan seçilmiş modeller listesi.
---
...
AWMate Zen, AWMate ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, AWMate'daki diğer sağlayıcılar gibi çalışır. AWMate Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve AWMate kullanmak için buna ihtiyacınız yoktur.
...
:::tip
AWMate ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
AWMate Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

AWMate Zen, AWMate'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>AWMate Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, AWMate Zen'i seçin ve API anahtarınızı yapıştırın.
...
AWMate yapılandırmanızdaki [model id](/docs/config/#models) `awmate/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `awmate/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için AWMate'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için AWMate'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için AWMate'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için AWMate'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için AWMate'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
AWMate Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca AWMate ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
