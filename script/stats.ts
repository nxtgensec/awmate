...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/awmate/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/awmate...\n")
...
console.log("Fetching npm all-time downloads for awmate-ai...\n")
const npmDownloads = await fetchNpmDownloads("awmate-ai")
